...
\begin{enumerate}[label=\textbf{D\arabic*}:,ref=D\arabic*,leftmargin=1.3cm]
	...
	\labelleditem{The school has an existing authentication system that can be used by the CKB platform}
	\labelleditem{Students and educators have an account on the existing authentication system}
