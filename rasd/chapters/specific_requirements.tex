...
\begin{enumerate}
      ...
      \item \textbf{External static analysis platforms} {-} in case they are chosen to
...
\begin{enumerate}[label=\textbf{R\arabic*}:,ref=R\arabic*,leftmargin=1.3cm]
      ...
      \begin{enumerate}[label=\textbf{R\arabic{enumi}.\arabic*}:,ref=R\arabic{enumi}.\arabic*, leftmargin=*]
            \labelledsubitem{The system shall allow the educator to specify the subscription deadline of a tournament.}
      ...
      \labelleditem{The system shall allow users to see the tournament ranks.}
...
\begin{enumerate}[label=\textbf{UC\arabic*}:,ref=UC\arabic*,leftmargin=1.3cm]
      ...
      \labelleditem{
            ...
            \begin{table}[H]
                  ...
                  \begin{tabular}{|l|p{11.9cm}|}
                        ...
                        \textbf{Actor}           & Educator who wants to create the badge             \\\hline
                        \textbf{Entry condition} &
                        \begin{itemize}
                              \item Educator is logged in
                        ...
                        \begin{enumerate}[label=\arabic*.]
                              ...
                              \item The educator writes JavaScript code to create new variables.
                              \item The educator writes one or more rules.
                              \item The educator clicks the confirmation button.
                              \item The platform creates the new badge in the current tournament.
                              \item The platform shows a confirmation massage.
                        \end{enumerate}            \\\hline
                        \textbf{Exit condition}  & The new badge is created in the current tournament \\\hline
                        \textbf{Exception}       & The rules contain undefined variables.
      ...
      \labelleditem{
            ...
            \begin{table}[H]
                  ...
                  \begin{tabular}{|l|p{11.9cm}|}
                        ...
                        \textbf{Actor}           & Educator who wants to create the battle, Students participating in the tournament                                                                           \\\hline
                        \textbf{Entry condition} &
                        \begin{itemize}
                              \item Educator is logged in
                        ...
                        \begin{enumerate}[label=\arabic*.]
                              ...
                              \item The educator selects the option to create a new battle.
                              ...
                              \item The platform sends to the educator a confirmation message.
                              \item The platform sends a notification to all students participating in the tournament.
                        \end{enumerate}                                                                                                \\\hline
      ...
      \labelleditem{
            ...
            \begin{table}[H]
                  ...
                  \label{table:Student joins to an existing Tournament by receiving a notification}
            \end{table}
            \begin{adjustbox}{
                        max size={\textwidth}{\textheightwithcaption{1}},
                        caption={Student joins to an existing Tournament by receiving a notification},
      ...
      \labelleditem{
            ...
            \begin{longtable}{|l|p{11.9cm}|}
                  ...
                  \begin{enumerate}[label=\arabic*.]
                        ...
                        \item The platform adds the inviting student to the created team.
                  ...
                  \begin{enumerate}[label=\arabic*.]
                        ...
                        \item The inviting student selects the option to participate in the battle with the new created team.
      ...
      \labelleditem{
            ...
            \begin{table}[H]
                  ...
                  \begin{tabular}{|l|p{11.9cm}|}
                        \hline
                        \textbf{Name}            & Student pushes and triggers automatic evaluation                                                                  \\\hline
                  ...
                  \label{table:Student pushes and triggers automatic evaluation}
            \end{table}
            \begin{adjustbox}{
            ...
            \begin{table}[H]
                  ...
                  \begin{tabular}{|l|p{11.9cm}|}
                        ...
                        \begin{itemize}
                              ...
                              \item Educator has enables manual evaluation for the battle
                        \end{itemize}                                                                   \\\hline
                        \textbf{Event flow}      &
                        \begin{enumerate}[label=\arabic*.]
                        ...
                        In this case the platform returns an error and the educator can assign the missing grades.                                            \\\hline
                        %\textbf{Special reqs}    &                                                      \\\hline
                  \end{tabular}
                  \caption{Educator manually evaluates teams    }
                  \label{table:Educator manually evaluates teams    }
            \end{table}
            \begin{adjustbox}{
                        max size={\textwidth}{\textheightwithcaption{1}},
                        caption={Educator manually evaluates teams},
...
A few hours of downtime are allowed between 1am and 5am, when students are usually not studying.
