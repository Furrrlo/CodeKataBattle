...
When the registration deadline of a battle expires, the platform creates a GitHub repository containing build automation scripts\comment{Tutti?} and tests provided by the educator.
...
\begin{description}[labelwidth=4em, leftmargin=5em, style=nextline]
    ...
    \item \textbf{Git:} A distributed version control system used for tracking changes in source code during software development. \cite{Git}
