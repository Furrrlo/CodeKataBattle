...
Uploading test cases they can decide if each test is public or private.
Public tests are provided to students, so that they can run them locally.
Private tests are used used for automatic evaluation, but they are not provided to students.
