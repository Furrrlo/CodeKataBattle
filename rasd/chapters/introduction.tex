...
\begin{description}[labelwidth=4em, leftmargin=5em, style=nextline]
    ...
    \item **Alloy official documentation:** [https://alloytools.org/documentation.html](https://alloytools.org/documentation.html)
    \item **Paper:** "Jackson and Zave: the world and the machine"
    \item **UML official specification:** [https://www.omg.org/spec/UML/](https://www.omg.org/spec/UML/)
    \item **BPMN official specification:** [https://www.omg.org/spec/BPMN/2.0/](https://www.omg.org/spec/BPMN/2.0/)
\end{description}
