...
The Notification Service uses RabbitMQ to create a queue where the Platform Service can push messages.
    ...
    \item[]
          \begin{enumerate}[label=\textbf{RW\arabic{enumi}.\arabic*}:,ref=RW\arabic{enumi}.\arabic*,leftmargin=0.5cm]
              ...
              \labelledsubitem{
                  ...
                  Then the Notification Service requests each student's endpoint URL from the API Gateway and sends the notifications.                  
                  \pagebreak
              }
          \end{enumerate}
