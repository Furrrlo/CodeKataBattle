...
If the API Gateway is replicated, a load balancer, such as the Amazon ELB \cite{ELB}, is necessary to equally distribute requests.
...
Sequence diagrams from \ref{{RW0.2}} to \ref{{RW0.4}} are common part that have been extracted for simplicity and are not shown in other diagrams.\\
